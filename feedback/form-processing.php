...
const EMAIL_SETTINGS = [
  'addresses' => ['lcpride@yandex.ru'], // кому необходимо отправить письмо
  'from' => ['maxx9050@gmail.com', 'Письмо с сайта'], // от какого email и имени необходимо отправить письмо
  'subject' => 'Новая заявка', // тема письма
  'host' => 'ssl://smtp.google.com', // SMTP-хост
  'username' => 'maxx9050@gmail.com', // // SMTP-пользователь
  'password' => 'vzilzagicfoknbff', // SMTP-пароль
  'port' => '465' // SMTP-порт
];
const HAS_SEND_NOTIFICATION = false;
const BASE_URL = 'https://lc-pride.ru';
const SUBJECT_FOR_CLIENT = 'Ваша заявка отправлена';
//
